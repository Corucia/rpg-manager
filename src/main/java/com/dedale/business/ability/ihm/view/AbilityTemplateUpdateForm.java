...
public class AbilityTemplateUpdateForm extends AbstractController<AnchorPane> {
    ...
    public AbstractController<?> redirection() throws ControllerException {
        AbilityTemplateListView controller = getControllerManager().getController(AbilityTemplateListView.class);
        getControllerManager().getRootController().getLayout().setCenter(controller.getLayout());
        return controller;
    }
